...
--
-- Host: localhost    Database: escuelaf
-- ------------------------------------------------------
...
CREATE TABLE `subject_by_course` (
  ...
  CONSTRAINT `subjectIDfk` FOREIGN KEY (`subjectIDfk`) REFERENCES `subjects` (`subjectID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2021-06-04 23:55:10
